...
public class client_frame extends javax.swing.JFrame 
{
    ...
    /// Start of Multiple Threads as per no. of users from the server.
    ...
    // User name entered is to be displayed.
    ...
    // When user disconnects with the server, then by this it will be known that
    // the user has lost connection / is offline
 ...
 /* if we want to implement multiple users from one server, the no. of users
     can be given here using a for loop. That means how much user can be online 
     connected with the same server and chat with other users.
 */
    ...
    /* Disconnect message for the user in case the server
     * is not yet started. Or it can be any failure in disconnection
     * of the use from Server or vice-versa.
     * */
    ...
    /*This is the Disconnect method for disconnecting 
     * the particular user from the server and displaying
     * Failed to disconnect if there are some problems
     * */
   ...
   /*GUI Designing*/
    ...
    }//event_b_connectActionPerformed

    private void b_disconnectActionPerformed(java.awt.event.ActionEvent evt) {//event_b_disconnectActionPerformed
        sendDisconnect();
        Disconnect();
    }//event_b_disconnectActionPerformed

    private void b_anonymousActionPerformed(java.awt.event.ActionEvent evt) {//event_b_anonymousActionPerformed
        tf_username.setText("");
        if (isConnected == false) 
        {
            String anon="anon";
    ...
    }//event_b_anonymousActionPerformed

    private void b_sendActionPerformed(java.awt.event.ActionEvent evt) {//event_b_sendActionPerformed
        String nothing = "";
